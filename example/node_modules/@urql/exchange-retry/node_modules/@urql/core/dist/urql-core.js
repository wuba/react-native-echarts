...
var ssrExchange = (params = {}) => {
  ...
  ssr.extractData = () => {
    var result = {};
    for (var key in data) if (data[key] != null) result[key] = data[key];
    return result;
  };
...
var subscriptionExchange = ({
  ...
  return ops$ => {
    ...
    })(wonka.filter(isSubscriptionOperationFn)(ops$));
    var forward$ = forward(wonka.filter(op => !isSubscriptionOperationFn(op))(ops$));
