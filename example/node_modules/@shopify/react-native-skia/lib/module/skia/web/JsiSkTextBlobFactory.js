...
export class JsiSkTextBlobFactory extends Host {
  ...
  MakeFromRSXformGlyphs(glyphs, rsxforms, font) {
    return new JsiSkTextBlob(this.CanvasKit, this.CanvasKit.TextBlob.MakeFromRSXformGlyphs(glyphs, rsxforms.map(f => JsiSkRSXform.fromValue(f)), JsiSkFont.fromValue(font)));
  }
